...
function promisifyQueryForBrands(query, user) {
...
function getAllBrand() {
    return promisifyQueryForBrands('SELECT * FROM brand');
}

function createNewBrand(brandData) {
    return promisifyQueryForBrands('INSERT INTO brand(brandName) VALUES(?)', brandData)
}
...
const create = async (request) => {
    const brand = await createNewBrand(request.body);
    return brand;
}
